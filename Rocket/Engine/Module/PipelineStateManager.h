...
namespace Rocket
{
    ...
    Interface PipelineStateManager : inheritance IRuntimeModule
    {
    public:
        ...
        virtual bool RegisterPipelineState(PipelineState& pipelineState);
        virtual void UnregisterPipelineState(PipelineState& pipelineState);
        virtual void Clear();

        const Ref<PipelineState> GetPipelineState(const String& name) const;
